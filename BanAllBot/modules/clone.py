...
from config import app, API_ID, API_HASH
...
async def _(app, message):
     ...
     try:
         ...
         client = Client (name="Okk", api_id=API_ID, api_hash=API_HASH, bot_token=token, in_memory=True, plugins=dict(root="BanAllBot/plugins"))
         await client.start()
